...
\"\n\
checkout_executable TCLSH \"/home/qihaol/ns-allinone-2.35/bin/tclsh8.5\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/qihaol/ns-allinone-2.35/bin/tclsh8.5\n\
but it doesn't seem to be there anymore, so\\\n\
...
FTFP	# routing protocl for industry network\n\
...
FTFP {\n\
set ragent [$self create-ftfp-agent $node]\n\
}\n\
AOMDV {\n\
...
\n\
Simulator instproc create-ftfp-agent { node } {\n\
set ragent [new Agent/FTFP [$node node-addr]]\n\
puts \"===[$node node-addr]===\" ;#test\n\
